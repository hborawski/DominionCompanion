...
class UtilitiesTest: XCTestCase {
    ...
    let card2 = Card(cost: 5, debt: 0, potion: false, actions: 1, buys: 0, cards: 2, name: "Laboratory", text: "Example Card", expansion: "ATest", types: ["Action"], trash: false, exile: false, tokens: TestData.noTokens, supply: true, related: [])
